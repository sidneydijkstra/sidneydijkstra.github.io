...
$(function() {
    $('.overlay-menu ul li a,.scroll-top a, .btn').bind('click', function(event) {
        var $anchor = $(this);
...
$(function() {
    ...
    var latitude = 53.2152932,
        longitude = 6.5375209,
        map_zoom = 16;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'assets/images/cd-icon-location.png' : 'assets/images/cd-icon-location.png';
