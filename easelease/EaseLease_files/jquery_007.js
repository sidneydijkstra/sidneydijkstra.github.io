...
(function($) {
	...
	var _date = new Date();
	var digitalTime = _date.toLocaleTimeString();
	digitalTime = digitalTime.slice(0, -3);

	var DATA_ATTRIBUTE = 'jquery.fbmessenger';
	var DEFAULTS = {
		botLogoUrl: 'botlogo.png',
		botName: 'jQuery.fbMessenger',
		botCategory: 'Specialist in leasen',
		...
		dateFormat: function(date) {
			...
			var month = ['JAN.', 'FEB.', 'MAR.', 'APR.', 'MEI', 'JUN.', 'JUL.', 'AUG.', 'SEP.', 'OCT.', 'NOV.', 'DEC.'];
	...
	var TRANSLATIONS = {
		en: {
			navBack: 'Terug',
			navOptions: 'instellingen',
			thousands: 'k',
			millions: 'M',
			responseTime: 'Wij zijn de brug tussen oud en nieuw',
			likes: '$LIKES likes',
			...
			inputPlaceholder: 'Stuur een bericht&hellip;'
		},
		de: {
			navBack: 'Startseite',
				...
				<div class="jsm-status-navbar">\
					<div class="jsm-status-bar">\
						...
						<div class="jsm-battery">\
							<span class="jsm-battery-percent">69 %</span>\
